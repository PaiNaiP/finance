...
const SavingTable = ({ saving }) => {
  ...
  useEffect(() => {
    const sorted = saving.sort((a, b) => new Date(a.year, monthsList.indexOf(a.month)) - new Date(b.year, monthsList.indexOf(b.month)));
    const groupedData = {};
    ...
    <div>
      ...
      <Modal show={show} onHide={() => setShow(false)}>
        <Modal.Header closeButton>
          <Modal.Title>Изменить сбережения</Modal.Title>
        </Modal.Header>
        <Modal.Body>
